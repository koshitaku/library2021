...
//    $mail->Port = 2525;
        ...
        $mail->Username = 'phungson.gka@gmail.com';
        $mail->Password = '09786665321';
        $mail->Port = 587;
        ...
        $mail->isHTML(true);
        $mailContent = "<p>本名： " . $book->name . " が借りた日： " . $return_time . ". ー期限が過ぎたので、返却をお願いします</p>";
        $mail->Body = $mailContent;
        if($mail->send()){
            $_SESSION['msg'] = "メールを出した。";
        }else{
            $_SESSION['error'] = "失敗しました。";
        }
//        var_dump($mail->Host);
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">返却期限が過ぎたリスト</h4>
                </div>
            </div>
            <div class="row">
                <?php if ($error != "") {
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">返却期限が過ぎたリスト</div>
                                        ...
                                        foreach ($results as $result) { ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    ...
                                                    <button class="btn btn-xs btn-primary">メールを出す</button>
                                                </td>
                                            </tr>
                                            <?php $cnt = $cnt + 1;
                                        }
